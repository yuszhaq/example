    ...
    <nav class="bg-gray-800">
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/contact" class="{{ request()->is('/contact') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}}">Contact</a>
        </div>
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">Yuszhaq Robot</div>
              <div class="text-sm font-medium leading-none text-gray-400">yuszhaqdev@gmail.com</div>
            </div>
