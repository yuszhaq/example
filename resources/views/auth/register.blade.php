...
<form method="POST" action="/register" class="flex items-center justify-center">
  @csrf
  
  <div class="space-y-12">
    <div class=" rounded-md border border-gray-900/10 p-6">
      <div class="grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
        <x-form-field>
          <x-form-label for="first_name">Fisrt Name</x-form-label>
